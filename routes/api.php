...
Route::group(['namespace'=>'Api'],function (){
    ...
    if (\App\SystemAddons::where('unique_identifier', 'otp')->first() != null && \App\SystemAddons::where('unique_identifier', 'otp')->first()->activated) {
        ...
        //Vendor
        Route::post('adminlogin',[AdminotpController::class,'login']);
        Route::post('home',[AdminotpController::class,'home']);
        Route::post('history',[AdminotpController::class,'history']);
        Route::post('orderdetails',[AdminotpController::class,'orderdetails']);
        Route::post('update',[AdminotpController::class,'update']);
        Route::get('drivers',[AdminotpController::class,'drivers']);
        Route::post('assign',[AdminotpController::class,'assign']);
        Route::post('updatepassword',[AdminotpController::class,'updatepassword']);
        Route::post('updateprofile',[AdminotpController::class,'updateprofile']);
    } else {
