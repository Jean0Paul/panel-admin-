                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input mr-0" type="radio" name="item_type" id="veg" value="1" @if($getitem->item_type == 1) checked @endif>
                                                <label class="form-check-label" for="veg">{{trans('labels.veg')}}</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input mr-0" type="radio" name="item_type" id="nonveg" value="2" @if($getitem->item_type == 2) checked @endif>
