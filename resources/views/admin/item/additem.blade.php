          ...
          <div class="card-body">
            ...
            <div id="privacy-policy-three" class="privacy-policy">
              <form method="post" action="{{ URL::to('admin/item/store') }}" name="about" id="about"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="item_name" id="item_name"
                        placeholder="{{ trans('labels.item_name') }}">
                      @error('item_name')
                        <span class="text-danger">{{ $message }}</span>
                      @enderror
                    </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-check form-check-inline">
                          <input class="form-check-input mr-0" type="radio" name="item_type" id="veg"
                            value="1" @if (old('item_type') == 1) checked @endif>
                        ...
                        <div class="form-check form-check-inline">
                          <input class="form-check-input mr-0" type="radio" name="item_type" id="nonveg"
                            value="2" @if (old('item_type') == 2) checked @endif>
                ...
                <div
                  class="row dn @if ($errors->has('variants_name.*') || $errors->has('variants_price.*')) dn @endif @if (old('variants') == 2) d-flex @endif"
                  id="price_row">
                ...
                <div class="row panel-body dn @if ($errors->has('variation.*') || $errors->has('product_price.*') || old('has_variation') == 1) d-flex @endif" id="variations">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control attribute" name="attribute" id="attribute"
                        placeholder="{{ trans('messages.enter_attribute') }}">
                      @error('attribute')
                        <span class="text-danger">{{ $message }}</span>
                      @enderror
                    </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control variation" name="variation[]" id="variation"
                  ...
                  <div class="col-sm-5">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control product_price" id="product_price"
                        name="product_price[]" placeholder="{{ trans('labels.product_price') }}">
                    </div>
                  </div>
                  <div class="col-sm-4 d-none">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control sale_price" id="sale_price" name="sale_price[]"
                        placeholder="{{ trans('labels.sale_price') }}" value="0">
                    </div>
                  </div>
                  <div class="col-sm-1">
                    <div class="form-group">
