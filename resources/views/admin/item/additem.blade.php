                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input mr-0" type="radio" name="item_type" id="veg" value="1" @if(old('item_type') == 1) checked @endif>
                                                <label class="form-check-label" for="veg">{{trans('labels.veg')}}</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input mr-0" type="radio" name="item_type" id="nonveg" value="2" @if(old('item_type') == 2) checked @endif>
                                                <label class="form-check-label" for="nonveg">{{trans('labels.nonveg')}}</label>
                                            </div>
                                            @error('item_type')<br><span class="text-danger">{{ $message }}</span>@enderror
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row dn @if($errors->has('variants_name.*') || $errors->has('variants_price.*')) dn @endif @if(old('variants') == 2) d-flex @endif" id="price_row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="price" id="price" placeholder="{{trans('labels.price')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="preparation_time" class="col-form-label">{{trans('labels.preparation_time')}}</label>
                                                <input type="text" class="form-control" name="preparation_time" id="preparation_time" placeholder="{{trans('labels.preparation_time')}}">
                                                @error('preparation_time')<span class="text-danger">{{ $message }}</span>@enderror
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
