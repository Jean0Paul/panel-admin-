            ...
            if(isset($request->footer_logo)){
                if($request->hasFile('footer_logo')){
                    ...
                    if(empty($about)){
                        ...
                        if($about->footer_logo != "" && file_exists('storage/app/public/admin-assets/images/about/'.$about->footer_logo)){
            ...
            if(isset($request->favicon)){
                if($request->hasFile('favicon')){
                    ...
                    if(empty($about)){
                        ...
                        if($about->favicon != "" && file_exists('storage/app/public/admin-assets/images/about/'.$about->favicon)){
            ...
            if(isset($request->logo)){
                if($request->hasFile('logo')){
                    ...
                    if(empty($about)){
                        ...
                        if($about->logo != "" && file_exists('storage/app/public/admin-assets/images/about/'.$about->logo)){
            ...
            if(isset($request->og_image)){
                if($request->hasFile('og_image')){
                    ...
                    if(empty($about)){
                        ...
                        if($about->og_image != "" && file_exists('storage/app/public/admin-assets/images/about/'.$about->og_image)){
            ...
            if(isset($request->mobile_app_image)){
                if($request->hasFile('mobile_app_image')){
                    ...
                    if(empty($about)){
                        ...
                        if($about->mobile_app_image != "" && file_exists('storage/app/public/admin-assets/images/about/'.$about->mobile_app_image)){
            ...
            if(isset($request->app_bottom_image)){
                if($request->hasFile('app_bottom_image')){
                    ...
                    if(empty($about)){
                        ...
                        if($about->app_bottom_image != "" && file_exists('storage/app/public/admin-assets/images/about/'.$about->app_bottom_image)){
