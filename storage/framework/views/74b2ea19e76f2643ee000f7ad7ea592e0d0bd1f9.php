                        ...
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                <a class="text-center" href="#">
                                    <center><img src="<?php echo e(Helper::image_path(@Helper::appdata()->logo)); ?>" height="100" width="100" alt=""></center>
                                </a>
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>123456</td>
                                            <td><button class="btn btn-info" onclick="AdminFill()"><?php echo e(trans('labels.copy')); ?></button></td>
                                        </tr>
                                        <tr>
                                            <td>Employee<br>employee@yopmail.com</td>
                                            <td>123456</td>
                                            <td><button class="btn btn-info" onclick="VendorFill()"><?php echo e(trans('labels.copy')); ?></button></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
...
</html><?php /**PATH E:\xampp\htdocs\single-restaurant\website\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>