                            ...
                            <div class="tab-pane fade show active" id="installed" role="tabpanel">
                                <div class="p-t-15">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="card">
                                            <img class="img-fluid" src='<?php echo URL("storage/app/public/addons/".$addon->image); ?>' alt="">
                                            <div class="card-body">
                                            ...
                                            <div class="card-footer">
                                                ...
                                                <a href="#" class="btn btn-sm btn-primary float-right" onclick="myFunction()">Activated</a>
                                                <?php else: ?>
                                                <a href="#" class="btn btn-sm btn-danger float-right" onclick="myFunction()">Deactivated</a>
                                                <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\single-restaurant\website\resources\views/admin/systemaddons/system-addons.blade.php ENDPATH**/ ?>